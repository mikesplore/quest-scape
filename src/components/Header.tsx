            ...
            {isAuthenticated && user ? (
              <div className="relative">
                ...
                >
                  ...
                  <span className="hidden sm:block text-caption font-medium text-text-primary">
                    {user.name}
                  </span>
                </button>
                ...
                <AnimatePresence>
                  {isUserMenuOpen && (
                    <motion.div
                      ...
                      className="absolute right-0 top-12 w-56 glass-card py-2 shadow-xl"
                    >
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.nav
              ...
              className="md:hidden py-4 border-t border-border-primary"
            >
